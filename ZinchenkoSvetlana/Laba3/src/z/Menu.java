...
public class Menu {
    ...
    public void inputData(){
          ...
          countHourlySalary = Keyin.inInt(" Please write How many people with hourly salary");

          int countFixedSalary;
          countFixedSalary = Keyin.inInt(" Please write How many people with fixed salary");
